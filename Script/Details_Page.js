...
// document.getElementById('header').innerHTML = navbar;  
  ...
  // Movie Cast link with movie id 
    // https://api.themoviedb.org/3/movie/718930/credits?api_key=9e997fe8c2efd000188bc88e3dda6d23&language=en-US
    // Search Movie = https://api.themoviedb.org/3/movie/{movie_id}?api_key=<<api_key>>&language=en-US
    ...
    <div id="videoSection" style="background-image: url(${imgPath}${data.backdrop_path});">
                ...
                <div class="movieDetails">
                    <div class="movenameandType">
                        <h3>${data.title}</h3>
                        <p>${data.release_date} (${data.original_language}) Action, Adventure, Thriller, Adventure RunTime ${data.runtime} MIN</p>
                    </div>
