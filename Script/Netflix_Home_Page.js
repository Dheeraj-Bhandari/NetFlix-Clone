                    ...
                    <div class="text">
                        <div id="texticon">
                            <div id="textfirst3icon">
                                ...
                                <button id="${item.id}" onclick="saveToMyListfromHomePage(${item.id})" ><i class="fa-1x fa-plus" aria-hidden="true"></i></button>
...
window.saveToMyListfromHomePage= saveToMyListfromHomePage;
...
function saveToMyListfromHomePage(id){
