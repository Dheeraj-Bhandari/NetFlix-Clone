...
<div class = "container">
    ...
    <div class="search">
        <input id ="input"  oninput = "debounceMovies()" type="text" placeholder="Titles, people, genres">
